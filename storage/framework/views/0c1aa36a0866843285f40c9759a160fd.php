...
<head>
    ...
    <title><?php echo e(config('app.name', 'Talksasa')); ?> - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
                        ...
                        <div class="hidden sm:ml-8 sm:flex sm:space-x-1">
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(auth()->user()->isAdmin()): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-indigo-600 border-indigo-500 inline-flex items-center px-4 py-2 border-b-2 text-sm font-semibold transition-all duration-200">
                                        <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
                                    </a>
                                    <a href="<?php echo e(route('admin.users')); ?>" class="text-gray-600 hover:text-indigo-600 border-transparent hover:border-indigo-300 inline-flex items-center px-4 py-2 border-b-2 text-sm font-medium transition-all duration-200">
                                        <i class="fas fa-users mr-2"></i>Users
                                    </a>
                                    <a href="<?php echo e(route('admin.payments')); ?>" class="text-gray-600 hover:text-indigo-600 border-transparent hover:border-indigo-300 inline-flex items-center px-4 py-2 border-b-2 text-sm font-medium transition-all duration-200">
                                        <i class="fas fa-credit-card mr-2"></i>Payments
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('dashboard')); ?>" class="text-indigo-600 border-indigo-500 inline-flex items-center px-4 py-2 border-b-2 text-sm font-semibold transition-all duration-200">
                                        <i class="fas fa-tachometer-alt mr-2"></i>Dashboard
                                    </a>
                                    <a href="<?php echo e(route('payments.index')); ?>" class="text-gray-600 hover:text-indigo-600 border-transparent hover:border-indigo-300 inline-flex items-center px-4 py-2 border-b-2 text-sm font-medium transition-all duration-200">
                                        <i class="fas fa-credit-card mr-2"></i>Payments
                                    </a>
                                    <a href="<?php echo e(route('merchants.index')); ?>" class="text-gray-600 hover:text-indigo-600 border-transparent hover:border-indigo-300 inline-flex items-center px-4 py-2 border-b-2 text-sm font-medium transition-all duration-200">
                                        <i class="fas fa-store mr-2"></i>Merchants
                                    </a>
                                    <a href="<?php echo e(route('sms-templates.index')); ?>" class="text-gray-600 hover:text-indigo-600 border-transparent hover:border-indigo-300 inline-flex items-center px-4 py-2 border-b-2 text-sm font-medium transition-all duration-200">
                                        <i class="fas fa-sms mr-2"></i>Templates
                                    </a>
                                    <a href="<?php echo e(route('settings.index')); ?>" class="text-gray-600 hover:text-indigo-600 border-transparent hover:border-indigo-300 inline-flex items-center px-4 py-2 border-b-2 text-sm font-medium transition-all duration-200">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(session('impersonating')): ?>
                                ...
                                <div class="bg-yellow-500 text-white px-4 py-2 rounded-lg mr-2 flex items-center space-x-2">
                                    ...
                                    <span class="text-sm font-medium">Impersonating: <?php echo e(auth()->user()->name); ?></span>
                                </div>
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-2 rounded-lg font-medium hover:shadow-lg transition-all duration-200 transform hover:scale-105">
        ...
        <?php if(!auth()->user()->isAdmin()): ?>
            <script>
                ...
                function loadSmsBalance() {
                    ...
                    fetch('<?php echo e(route("settings.balance")); ?>', {
                        method: 'GET',
                        headers: {
...
<?php /**PATH /home/zumi/php/mpesa-notifications/resources/views/layouts/app.blade.php ENDPATH**/ ?>