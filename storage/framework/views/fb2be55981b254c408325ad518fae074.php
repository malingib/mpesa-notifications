    ...
    <div class="mb-8 animate-fade-in">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="<?php echo e(route('sms-templates.create')); ?>" class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-200 transform hover:scale-105">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-6 border border-gray-200/50 animate-fade-in">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($totalTemplates ?? 0)); ?></p>
                </div>
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-6 border border-gray-200/50 animate-fade-in" style="animation-delay: 0.1s">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600"><?php echo e(number_format($activeTemplates ?? 0)); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden animate-fade-in hover:shadow-2xl transition-all duration-200">
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-bold text-gray-900"><?php echo e($template->name); ?></h3>
                ...
                <div class="px-6 py-4">
                    <p class="text-sm text-gray-700 mb-4 line-clamp-3"><?php echo e($template->message); ?></p>
                    ...
                    <div class="flex items-center justify-between text-xs text-gray-500 mb-4">
                        <span><i class="fas fa-calendar mr-1"></i><?php echo e($template->created_at->format('M d, Y')); ?></span>
                        <span><i class="fas fa-edit mr-1"></i><?php echo e($template->updated_at->diffForHumans()); ?></span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <a href="<?php echo e(route('sms-templates.edit', $template->id)); ?>" class="flex-1 bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors text-center">
                            <i class="fas fa-edit mr-1"></i>Edit
                        </a>
                        <button 
                            type="button"
                            onclick="previewTemplate('<?php echo e($template->id); ?>', '<?php echo e(addslashes($template->message)); ?>')"
                            class="flex-1 bg-gray-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-700 transition-colors"
                        >
                            <i class="fas fa-eye mr-1"></i>Preview
                        </button>
                        <form 
                            action="<?php echo e(route('sms-templates.destroy', $template->id)); ?>" 
                            method="POST" 
                            class="inline"
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-full bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 p-12 text-center animate-fade-in">
                ...
                <a href="<?php echo e(route('sms-templates.create')); ?>" class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-200 inline-block">
...
<script>
    function previewTemplate(id, message) {
        ...
        fetch('<?php echo e(route("sms-templates.preview")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zumi/php/mpesa-notifications/resources/views/sms-templates/index.blade.php ENDPATH**/ ?>