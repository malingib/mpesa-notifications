...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden animate-fade-in">
            ...
            <form action="<?php echo e(route('settings.update-sms')); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="sender_id" 
                            name="sender_id" 
                            value="<?php echo e(old('sender_id', $settings['sms']['sender_id'] ?? '')); ?>"
                            maxlength="11"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['sender_id'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                value="<?php echo e(old('talksasa_api_token', $settings['sms']['talksasa_api_token'] ?? '')); ?>"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['talksasa_api_token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> pr-12"
                        ...
                        <?php $__errorArgs = ['talksasa_api_token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div id="notificationNumbersContainer" class="space-y-2">
                            ...
                            ?>
                            <?php $__currentLoopData = $notificationNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden animate-fade-in" style="animation-delay: 0.1s">
            ...
            <form action="<?php echo e(route('settings.update-payment')); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select 
                            id="account_type" 
                            name="account_type" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['account_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        >
                            ...
                            <option value="paybill" <?php echo e(old('account_type', $settings['payment']['account_type'] ?? '') === 'paybill' ? 'selected' : ''); ?>>Paybill</option>
                            <option value="till" <?php echo e(old('account_type', $settings['payment']['account_type'] ?? '') === 'till' ? 'selected' : ''); ?>>Till Number</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="account_number" 
                            name="account_number" 
                            value="<?php echo e(old('account_number', $settings['payment']['account_number'] ?? '')); ?>"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['account_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="<?php echo e(old('business_shortcode', $settings['payment']['business_shortcode'] ?? '')); ?>"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['business_shortcode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php $__errorArgs = ['business_shortcode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                id="consumer_key" 
                                name="consumer_key" 
                                value="<?php echo e(old('consumer_key', $settings['payment']['consumer_key'] ?? '')); ?>"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['consumer_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                value="<?php echo e(old('consumer_secret', $settings['payment']['consumer_secret'] ?? '')); ?>"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['consumer_secret'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input 
                                ...
                                id="passkey" 
                                name="passkey" 
                                value="<?php echo e(old('passkey', $settings['payment']['passkey'] ?? '')); ?>"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['passkey'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input 
                                    type="url" 
                                    id="confirmation_url" 
                                    value="<?php echo e(url('/api/webhooks/mpesa/payment')); ?>"
...
<script>
    ...
    document.getElementById('testSmsConnection').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("settings.test-sms")); ?>', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('testPaymentCredentials').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("settings.test-payment")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
    ...
    document.getElementById('registerUrls').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("settings.register-urls")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zumi/php/mpesa-notifications/resources/views/settings/index.blade.php ENDPATH**/ ?>